...
public class Calculadora2 {
	...
	private static Calculadora2 calculadora = null;
	
	static {
		Calculadora2 calculadora = new Calculadora2(1);
	}
	
	public static Calculadora2 getCurrent() {
		if(calculadora == null)
			calculadora = new Calculadora2(0);
		return calculadora;
	}
	
	// private Calculadora() {}
	public Calculadora2(int algo) {
		readOnly = algo;
	}
