...
public class MainJuegoNaipes {
	...
	public void run() throws Capgemini.JuegoDelNumero.JuegoException, JuegoException {
		naipes();
	}
	...
	public void juegoConClase() throws Capgemini.JuegoDelNumero.JuegoException, JuegoException {
		Scanner teclado = new Scanner(System.in);
	...
	private void naipes() throws Capgemini.JuegoDelNumero.JuegoException, JuegoException {
