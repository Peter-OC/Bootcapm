...
import Bootcamp.PersonaAlumno.Alumno;
...
class Calculadora2Test {
	...
	class Suma {
		...
		class OK {
			...
			void testSumaDoubleDouble2() {
				assertEquals(10.11, Calculadora2.suma(1, -0.9), 7);
			}
			@Test
			@Tag("smoke")
	...
	class Resta {
		...
		class OK {
			...
			void Validas(double operando1, double operando2, double resultado) {
				assertEquals(resultado, Calculadora2.resta(operando1, operando2));
			}
		}
	}
	...
	class Divide {
		...
		class OK {
			...
			void divide_enteros_OK() {
				assertEquals(1.5, Calculadora2.divide(3, 2));
			}
			@Test
			void divide_por_0_enteros() {
				//assertEquals(0, Calculadora.divide(3, 0));
				assertThrows(ArithmeticException.class, () -> Calculadora2.divide(3, 0));
			}
			@Test
			void divide_con_decimales_OK() {
				assertEquals(1, Calculadora2.divide(3.0, 2.0));
			}
			@Test
			void divide_por_0_con_decimales() {
				//assertEquals(Double.POSITIVE_INFINITY, Calculadora.divide(3.0, 0));
				assertThrows(ArithmeticException.class, () -> Calculadora2.divide(3.0, 0));
			}
			@Test
			void probando() {
