package Bootcamp.PersonaAlumno;
...
import Bootcamp.Autor;
import Bootcamp.Calculadora2;
import Bootcamp.CalculadoraCientifica;
import Bootcamp.Dias;
import Bootcamp.DiasLaborables;
import Bootcamp.EjemplosGenericos;
import Bootcamp.Factura;
import Bootcamp.Grafico;
import Bootcamp.EjemplosGenericos.Elemento;
import Bootcamp.Factura.Estado;
...
//				System.out.println("ERRROR: " + e.getMessage());
		...
		public static void ejemplos2(String[] args) {
			...
			Calculadora2 c = Calculadora2.getCurrent();// new Calculadora();
//			System.out.println(c.avg());
			System.out.println(c.avg(5));
			System.out.println(c.avg(1, 2, 3, 4, 5));
			double i = Calculadora2.suma(0, 0.0);
